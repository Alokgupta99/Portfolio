        ...
        <nav className="fixed w-full z-50 bg-dark-100/90 backdrop-blur-sm py-4 px-8 shadow-lg">
            <div className="container mx-auto flex justify-between items-center">
                <div>
                    <a href="#" className="text-3xl font-bold text-white">
                        Emma
                        <span className="text-purple">Watson</span>
                ...
                <div className="md:hidden">
                   {
                       showMenu ?
                       <FaXmark onClick={()=>setShowMenu(!showMenu)} className="text-2xl cursor-pointer float-right"/>:
                       <FaBars onClick={()=>setShowMenu(!showMenu)} className="text-2xl cursor-pointer float-right"/>
                   }
...

            {
                showMenu &&(    
                    ...
                    <a href="#skills" className="relative text-white/80 transition duration-30 hover:text-purple group">    
                        <span>Skills</span>
                    </a>
